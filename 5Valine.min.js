    ...
    ([function (e, t, n) {
                ...
                (0, a.default)(l.default, {
                    ...
                    ajax: function (e) {
                        ...
                        .toString.call(e.data) ? e.data : function (e) {
                            var t = [];
                            for (var n in e)
                ...
                o.prototype.init = function (e) {
                    ...
                    var t = this;
                    return e && (e = y.default.extend(h.defaultConfig, e), t.i18n = (0, d.default)(e.lang || y.default.lang, e.langMode), t.config = e, f.default.maps = !!e.emojiMaps && e.emojiMaps || f.default.maps, f.default.cdn = !!e.emojiCDN && e.emojiCDN || f.default.cdn, t._init()),
                    t
                },
                ...
                I = {
                    ...
                    show: function (e, t) {
                        ...
                        if (t.forEach(function (e) {
                                ...
                                t && t.text("0"),
                                n.push(/\%/.test((0, y.default)(e).attr("id")) ? decodeURI((0, y.default)(e).attr("id")) : (0, y.default)(e).attr("id"))
                            }), n.length) {
                ...
                o.prototype.bind = function () {
                    ...
                    var C = function (t, n, r) {
                        ...
                        i = t.get("ua"),
                        a = "";
                        i && !/ja/.test(e.config.lang) && (i = y.default.detect(i), a = '<span class="vsys">' + i.browser + " " + i.version + '</span> <span class="vsys">' + i.os + " " + i.osVersion + "</span>"),
                    ...
                    M = function () {
                        setTimeout(function () {
                            try {
                                ...
                                "renderMathInElement" in window && renderMathInElement((0, y.default)(".v")[0], {
                                    delimiters: [{
                                            left: "$$",
                                            right: "$$",
                                            display: !0
                    ...
                    U = function () {
                        ...
                        n.save().then(function (t) {
                            ...
                            try {
                                I.rid ? C(t, (0, y.default)('.vquote[data-self-id="' + I.rid + '"]'), !0) : (Number(n.text()) ? n.text(Number(n.text()) + 1) : e.$el.find(".vcount").show().find(".vnum").text(Number(n.text()) + 1), C(t, e.$el.find(".vcards")), k.skip++),
                    ...
                    z.on("click", L),
                    (0, y.default)(document).on("keydown", function (e) {
                        e = event || e;
                        ...
                        n.prototype.token = function (e, t) {
                            ...
                            for (var n, r, o, i, a, s, l, c, u, d, p, h, g; e; )
                                if ((o = this.rules.newline.exec(e)) && (e = e.substring(o[0].length), o[0].length > 1 && this.tokens.push({
                                    ...
                                    e = e.substring(o[0].length), o = o[0].replace(/^ {4}/gm, ""), this.tokens.push({
                                        type: "code",
                                    ...
                                    e = e.substring(o[0].length), o[3] && (o[3] = o[3].substring(1, o[3].length - 1)), u = o[1].toLowerCase().replace(/\s+/g, " "), this.tokens.links[u] || (this.tokens.links[u] = {
                                            href: o[2],
                                            title: o[3]
                                        });
                        ...
                        r.prototype.output = function (e) {
                            for (var t, n, o, i, a, l = ""; e; )
                                if (a = this.rules.escape.exec(e))
                                    ...
                                    e = e.substring(a[0].length), "@" === a[2] ? (n = s(this.mangle(a[1])), o = "mailto:" + n) : (n = s(a[1]), o = n), l += this.renderer.link(o, null, n);
                                    ...
                                    if (a = this.rules.tag.exec(e))
                                        ...
                                        e = e.substring(a[0].length), this.inLink = !0, o = a[2], this.options.pedantic ? (t = /^([^'"]*[^\s])\s+(['"])(.*)\2/.exec(o), t ? (o = t[1], i = t[3]) : i = "") : i = a[3] ? a[3].slice(1, -1) : "", o = o.trim().replace(/^<([\s\S]*)>$/, "$1"), l += this.outputLink(a, {
                                            href: r.escapes(o),
                                            title: r.escapes(i)
                                        }), this.inLink = !1;
                                    ...
                                    a[0] = this.rules._backpedal.exec(a[0])[0], e = e.substring(a[0].length), "@" === a[2] ? (n = s(a[0]), o = "mailto:" + n) : (n = s(a[0]), o = "www." === a[1] ? "http://" + n : n), l += this.renderer.link(o, null, n);
                            return l
                        },
                ...
                function u(e, t) {
                    ...
                    if (t.singleton) {
                        ...
                        e.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = l(t), r = f.bind(null, n, t), o = function () {
                            a(n),
